...
bool ecs_field_is_set(struct ecs_iter_t const *, int32_t);
ecs_id_t ecs_field_id(struct ecs_iter_t const *, int32_t);
ecs_entity_t ecs_field_src(struct ecs_iter_t const *, int32_t);
int ecs_field_size(struct ecs_iter_t const *, int32_t);
bool ecs_field_is_self(struct ecs_iter_t const *, int32_t);
bool ecs_defer_begin(struct ecs_world_t *);
bool ecs_is_deferred(struct ecs_world_t const *);
bool ecs_defer_end(struct ecs_world_t *);
void ecs_defer_suspend(struct ecs_world_t *);
void ecs_defer_resume(struct ecs_world_t *);
bool ecs_stage_is_readonly(struct ecs_world_t const *);
bool ecs_stage_is_async(struct ecs_world_t *);
